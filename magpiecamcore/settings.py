"""
Django settings for magpiecamcore project.
...
ROOT_URLCONF = 'magpiecamcore.urls'
...
WSGI_APPLICATION = 'magpiecamcore.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DATABASE_NAME', 'magpiecamcoredb'),
